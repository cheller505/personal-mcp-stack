...
SERVICE_NAME="clickup-mcp.service"

echo "=== ClickUp MCP Server Installer ==="
echo ""
...
# ── Config dir ────────────────────────────────────────────────────────────────
mkdir -p "$HOME/.clickup-mcp"
chmod 700 "$HOME/.clickup-mcp"
...
echo "│  Next steps                                                 │"
echo "│                                                             │"
echo "│  1. First run (interactive — prompts for API token):       │"
...
echo "│                                                             │"
echo "│  Logs: tail -f ~/.clickup-mcp/sync.log                      │"
echo "└─────────────────────────────────────────────────────────────┘"
echo ""
